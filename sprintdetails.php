...
<head>
    ...
    <!-- <link rel="stylesheet" href="./css/sprint deatails.css"> -->
...
body{
  ...
  height: 35px;
    ...
    background-color: #ff7418; /* Sets the background color */
...
.button {
    ...
    background-color: #ff7418; /* Sets the background color of the buttons */
...
.button:hover {
    background-color: #e65c00; /* Changes the background color on hover */
}
/* naaaavvvv */
.items {
    display: flex;
